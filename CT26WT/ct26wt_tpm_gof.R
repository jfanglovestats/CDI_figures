...
TPM = function(count, glen_vec){
  RPK = sweep(count, 1, FUN = "/", (glen_vec / 10^3))
  return(sweep(RPK * (10^6), 2, FUN = "/", colSums(RPK))) 
}
...
gof_data = round(TPM(count = process_data[intersect_gene,], 
...
saveRDS(gs_nb_pval_df, "wt1_tpm_gs_nb_pval_df.rds")
...
saveRDS(gs_zinb_pval_df, "wt1_tpm_gs_zinb_pval_df.rds")
...
saveRDS(gc_nb_pval_df, "wt1_tpm_gc_nb_pval_df.rds")
...
saveRDS(gc_zinb_pval_df, "wt1_tpm_gc_zinb_pval_df.rds")
...
gc_nb_pval_df = readRDS("wt1_tpm_gc_nb_pval_df.rds")
gc_zinb_pval_df = readRDS("wt1_tpm_gc_zinb_pval_df.rds")
gs_nb_pval_df = readRDS("wt1_tpm_gs_nb_pval_df.rds")
gs_zinb_pval_df = readRDS("wt1_tpm_gs_zinb_pval_df.rds")
...
saveRDS(discoveries, "wt1_tpm_discoveries.rds")
